...
function UnitInfoTracker:UpdateAllData()
    ...
    local className, classToken = UnitClass(self.unitId)
    self.classToken = classToken or ""
    self.classDisplayName = className or ""
...
local REACTION_COLORS = {
    ...
    [2] = "ffff00",  -- neutral
    [3] = "55ff55",  -- friendly
    [4] = "8888ff",  -- friendly player
    [5] = "008800",  -- friendly player PvP
    [6] = "cccccc",  -- not tapped
}

function UnitInfoTracker:GetReactionColor()
    return REACTION_COLORS[self.reaction] or "ffffff"
end
