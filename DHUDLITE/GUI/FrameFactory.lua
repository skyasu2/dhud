...
function FrameFactory:CreateCastBarFrame(name, parent, pointThis, pointParent, offX, offY, w, h, textureName, mirror)
    local frame, texture = self:CreateTextureFrame(name, parent, pointThis, pointParent, offX, offY, w, h, textureName, mirror, "BORDER")
    texture:ClearAllPoints()
    texture:SetPoint("CENTER", frame, "CENTER", 0, 0)
    return frame, texture
end
...
function FrameFactory:CreateCastBarIconFrame(name, parent, pointThis, pointParent, offX, offY, w, h)
    ...
    local border = frame:CreateTexture(name and (name .. "_border") or nil, "ARTWORK", nil, 7)
    border:SetTexture(texturePath)
    border:SetVertexColor(1, 1, 1)
    border:SetPoint("TOPLEFT", frame, "TOPLEFT", -9 * scaleX, 8 * scaleY)
    border:SetWidth(38 * scaleX)
